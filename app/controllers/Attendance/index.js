...
class Attendance extends DB {
    ...
    InsertAttendance =(req, res, next)=>
    {
        ...
        const query=`INSERT INTO ATTENDANCE(ID,SECTION_ID,STUDENT_ID,COURSE_ID,INSTRUCTOR_ID,ISLAB,CLASS_DATE,IS_ATTEND) VALUES('${ID}','${Section_ID}','${Student_ID}','${Course_ID}','${Instructor_ID}','${IsLab}','${Class_Date}','${Is_Attend}')`;
